...
class DefaultController extends Controller
{
    ...
    public function searchAction(Request $request)
    {
		...
		return $this->render('SinamCoreBundle:Default:search.html.twig', array( 'form' => $form->createView(), 'depto' => $depto, 'muni' => $ctlMunicipios, 'establecimiento' => $CtlEstablecimiento, 'all' =>  $all));
    }
