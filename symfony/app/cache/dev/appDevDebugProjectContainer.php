...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'sinam-dev', 'user' => 'acrasame', 'password' => 'acrasame', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Sinam/CoreBundle/Resources/config/doctrine') => 'Sinam\\CoreBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Sinam\\CoreBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('SinamCoreBundle' => 'Sinam\\CoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d346edc1163be7541552cfa593625e1afed21382467d321549c555cd0befb319');
    ...
    {
        return $this->services['ewz_recaptcha.form.type'] = new \EWZ\Bundle\RecaptchaBundle\Form\Type\EWZRecaptchaType('6LccTyITAAAAALuynzFnB2AqpAxftp07FedqKVUA', true, true, 'es');
    }
    ...
    {
        return $this->services['ewz_recaptcha.validator.true'] = new \EWZ\Bundle\RecaptchaBundle\Validator\Constraints\IsTrueValidator(true, '6LccTyITAAAAAAHtj4L1niTWHJwc_n8jg_Ne2NS0', $this->get('request_stack'), array('host' => NULL, 'port' => NULL, 'auth' => NULL));
    }
    ...
    {
        return $this->services['genemu.gd.captcha'] = new \Genemu\Bundle\FormBundle\Gd\Type\Captcha($this->get('session'), 'ede9d97d0b2621973e4b00307091aa84e7701e76');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Sinam/CoreBundle/Resources/views'), 'SinamCore');
        $instance->addPath(($this->targetDirs[3].'/vendor/genemu/form-bundle/Genemu/Bundle/FormBundle/Resources/views'), 'GenemuForm');
        $instance->addPath(($this->targetDirs[3].'/src/EWZ/Bundle/RecaptchaBundle/Resources/views'), 'EWZRecaptcha');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ede9d97d0b2621973e4b00307091aa84e7701e76');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\ExpressionValidator' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'Symfony\\Component\\Security\\Core\\Validator\\Constraints\\UserPasswordValidator' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'Symfony\\Bridge\\Doctrine\\Validator\\Constraints\\UniqueEntityValidator' => 'doctrine.orm.validator.unique', 'ewz_recaptcha.true' => 'ewz_recaptcha.validator.true', 'EWZ\\Bundle\\RecaptchaBundle\\Validator\\Constraints\\IsTrueValidator' => 'ewz_recaptcha.validator.true')));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('575db4b8ef2915.13872991')), true);
    ...
    {
        return $this->services['twig.form.renderer'] = new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'EWZRecaptchaBundle:Form:ewz_recaptcha_widget.html.twig', 2 => 'GenemuFormBundle:Form:div_layout.html.twig', 3 => 'GenemuFormBundle:Form:jquery_layout.html.twig', 4 => 'GenemuFormBundle:Form:stylesheet_layout.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SinamCoreBundle' => 'Sinam\\CoreBundle\\SinamCoreBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'sinam-dev',
            'database_user' => 'acrasame',
            'database_password' => 'acrasame',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ede9d97d0b2621973e4b00307091aa84e7701e76',
            'locale' => 'es',
            ...
            'kernel.secret' => 'ede9d97d0b2621973e4b00307091aa84e7701e76',
            ...
            'ewz_recaptcha.public_key' => '6LccTyITAAAAALuynzFnB2AqpAxftp07FedqKVUA',
            'ewz_recaptcha.private_key' => '6LccTyITAAAAAAHtj4L1niTWHJwc_n8jg_Ne2NS0',
