 ...
 */
class CtlMunicipio extends \Sinam\CoreBundle\Entity\CtlMunicipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CtlMunicipio $proxy) {
    ...
    public function setCodigoCnr($codigoCnr)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodigoCnr', array($codigoCnr));

        return parent::setCodigoCnr($codigoCnr);
    }
    ...
    public function getCodigoCnr()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCodigoCnr', array());

        return parent::getCodigoCnr();
    }
