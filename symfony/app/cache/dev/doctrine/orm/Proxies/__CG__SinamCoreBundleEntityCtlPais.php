 ...
 */
class CtlPais extends \Sinam\CoreBundle\Entity\CtlPais implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sinam\\CoreBundle\\Entity\\CtlPais' . "\0" . 'id', '' . "\0" . 'Sinam\\CoreBundle\\Entity\\CtlPais' . "\0" . 'nombre', '' . "\0" . 'Sinam\\CoreBundle\\Entity\\CtlPais' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CtlPais $proxy) {
